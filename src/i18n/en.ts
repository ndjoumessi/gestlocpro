...
export const en: Dictionary = {
  ...
  app: {
    ...
    documents: {
      ...
      inspectionPending: 'It has not been recorded yet. It will appear here after the entry visit.',
    ...
    tenant: {
      ...
      linkTitle: 'Received a code for your home?',
    ...
    inspections: {
      ...
      finishFinding: 'Finish finding {rank}',
      editFinding: 'Edit finding {rank}',
      costOf: 'Charge: {amount}',
    ...
    works: {
      ...
      quote: 'Quote',
      reply: 'Reply',
      replyFromManager: 'Reply from management',
      replyFromTenant: 'Reply from tenant',
      replyTitle: 'Reply to the tenant',
      replyBody: 'Your reply lands in their notifications, attached to report {reference}.',
      copiesDelivered: '{count} email copies delivered · {date}',
      copiesDelivered_one: '1 email copy delivered · {date}',
      ...
      samples: {
        ...
        frontDoorLock: 'Front door lock sticking',
    ...
    access: {
      ...
      grant: 'Grant',
      refuse: 'Decline',
      granted: 'Access granted · nothing assigned yet',
    ...
    tenants: {
      ...
      searchShort: 'Name, unit…',
      searchEmpty: 'No tenant matches.',
      searchEmptyHint: 'Try a name, a unit number or a phone number — or go back to “All”.',
    ...
    onboarding: {
      ...
      requestTitle: 'Request access to a portfolio',
      requestBody: 'No code? Enter the owner’s email address. Your request will appear in their access registry, and they will decide.',
      requestEmail: 'Owner’s email address',
      request: 'Send request',
      requested: 'Request sent · the owner will decide',
    ...
    report: {
      ...
      mine: 'My reports',
      replyFrom: 'Reply from your manager',
      replyMine: 'Your reply',
      replyLabel: 'Reply',
      replyHint: 'Your manager and landlord receive it.',
      replySend: 'Send reply',
      replySent: 'Reply sent',
      replyError: 'At least 3 characters.',
